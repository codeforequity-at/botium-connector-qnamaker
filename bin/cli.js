...
yargsCmd.usage('Botium Connector QnA Maker CLI\n\nUsage: $0 [options]') // eslint-disable-line
  ...
  .command({
    command: 'import',
    describe: 'Downloading Convos and Utterances from QnA Maker to Botium',
    builder: (yargs) => {
  ...
  .command({
    command: 'export',
    describe: 'Uploading Utterances from Botium to QnA Maker',
    builder: (yargs) => {
